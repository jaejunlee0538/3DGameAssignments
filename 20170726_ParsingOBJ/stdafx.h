...
#define MAKE_VAR_AND_GETSETTER(varIdentifier, varType, varName, funcPostfix)	\
	varIdentifier: varType _varName;\
	public: varType get##funcPostfix() const{return _varName;}\
	public: void set##funcPostfix(varType varName) { _varName = varName; }
	
#define MAKE_VAR_AND_GETSETTER_REFERENCE(varIdentifier, varType, varName, funcPostfix)	\
	varIdentifier: varType _varName;\
	public: const varType& get##funcPostfix() const {return _varName;}\
	public: void set##funcPostfix(const varType& varName) { _varName = varName; }
