...
namespace SGA {
	...
	void cMainGame::Setup()
	{
		...
		_character1 = new Minecrafcharacter();
		_character2 = new Minecrafcharacter();
		...
		_aseParser.load("C:/Users/jaeju/Desktop/3DGameLecture/20170728_ASEParser/woman/woman_01_all.ASE", &loadedObject);
		loadedObject->setPosition(0, 0, 0);
		loadedObject->setRotation(0, 0, 0);
		LogDebugMessage("%d\n", loadedObject->getNObjects());
	}
