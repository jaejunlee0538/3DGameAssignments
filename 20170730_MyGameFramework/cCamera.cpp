...
void cCamera::Setup(float yFoV, float aspect, float zNear, float zFar)
{
	D3DXMatrixPerspectiveFovLH(&m_matProj, yFoV, aspect, zNear, zFar);
...
void cCamera::SetDistanceToTarget(float dist)
{
	m_distToTarget = dist;
	CalculateLookAtMatrix();
}
