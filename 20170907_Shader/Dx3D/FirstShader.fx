...
// Pass 0
//--------------------------------------------------------------//
string Default_DirectX_Effect_Pass_0_bunny : ModelData = "..\\..\\..\\..\\..\\..\\Program Files (x86)\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\bunny.obj";
...
{
   VS_OUTPUT Output;
   float4 output = mul(Input.Position, matWorld);
   output = mul(output, matView);
   Output.Position = mul(output, matProj);
